...
export default function Index() {
	...
	// Expo Updates'in durumunu native tarafta anlık takip eden hook
	const { isUpdateAvailable, isUpdateReady } = Updates.useUpdates();
	...
	// 2. İndirme TAMAMLANDIĞINDA (Ready olduğunda) kullanıcıya sor ve reload at
	useEffect(() => {
		if (isUpdateReady) {
			Alert.alert(
				"Yeni Güncelleme!",
				"Güncelleme hazır. Uygulamayı şimdi yenilemek ister misiniz?",
				[
					{
						text: "Yenile",
						onPress: async () => {
							// Artık bundle diskte %100 hazır olduğu için anında yeni sürüme geçer
	...
	// Manual tetikleme (Ön plana gelince kontrol et)
	useEffect(() => {
